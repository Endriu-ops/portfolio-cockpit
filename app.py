...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v7.2", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v7.2")
st.caption("V7.2: DFNS Defense fix, permanent RBOT/DFNS portfolio, Extended 10Y Backtest.")
...
with tabs[21]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v7.2: test alert.")
