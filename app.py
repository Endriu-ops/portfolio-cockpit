...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v6.2", layout="wide")
...
def stress_test_estimate(real_df, scenario):
    ...
    mapping = {
        ...
        "CMOD.MI":"Commodities","CBTC.MI":"Crypto","SXR8":"Equity","ZPRV":"Equity",
...
st.title("Portfolio Cockpit Alpha Pro v6.2")
st.caption("Decision Engine v6.2: ticker resolver, manual price fallback, Data Quality.")
...
with tabs[18]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v6.2: test alert.")
