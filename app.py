...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v10.5.5", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v10.5.5")
...
max_new_positions_v105 = st.session_state.get("max_new_positions_v105", 0)
...
with tabs[2]:  # Geographic Engine
    ...
    if rt is None or rt.empty:
        ...
        geo_pac = geographic_pac_priority(rt, pac_amount, regime_payload_geo, max_new_positions_v105 if "max_new_positions_v105" in globals() else 0)
        if geo_pac.empty:
...
with tabs[18]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v10.5.5: test alert.")
