...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v6.7", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v6.7")
st.caption("Decision Engine v6.7: Tax Engine monitor-only, rebalance tax opt-in, persistence engine.")
...
with tabs[18]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v6.7: test alert.")
