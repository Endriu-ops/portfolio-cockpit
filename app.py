...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v6.1", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v6.1")
st.caption("Decision Engine v6.1: AI 5%, Defense 5%, tactical 3%, no VUSA/WSML.")
...
with tabs[17]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v6.1: test alert.")
