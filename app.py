...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v8.2", layout="wide")
...
def load_portfolio_primary(vix_override=None):
    """
    V8.2: carica prima portfolio_positions.csv.
...
# UI
# ══════════════════════════════════════════════════════════════════════════════
st.title("Portfolio Cockpit Alpha Pro v8.2")
...
with tabs[22]:  # Alerts
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v8.2: test alert.")
