...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v6.9", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v6.9")
...
with tabs[18]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v6.9: test alert.")
