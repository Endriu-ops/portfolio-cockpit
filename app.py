...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v9.0", layout="wide")
...
# UI
# ══════════════════════════════════════════════════════════════════════════════
st.title("Portfolio Cockpit Alpha Pro v9.0")
st.caption("v9.0 — Regime & Crisis Engine · Dynamic Risk Budget · Crisis Protocol · Regime-aware PAC")
...
with tabs[7]:  # Regime & Crisis V9
    st.subheader("🛡️ Regime & Crisis Engine V9.0")
...
with tabs[10]:  # Relative Strength
    out=[]
...
with tabs[18]:  # Tax Optimizer Pro
    st.subheader("🧾 Tax Optimizer Pro V9.0")
    ...
    if "real_table" not in st.session_state:
        ...
        st.info(
            "Gerarchia V9.0: 1) usa PAC/nuova liquidità; 2) compra sottopesi; "
            "3) vendi solo se entro budget fiscale; 4) differisci vendite con fiscal drag elevato."
        )


with tabs[19]:  # Tax Engine
...
with tabs[22]:  # Scenario Simulator
...
with tabs[24]:  # Alerts
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v9.0: test alert.")
