...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v8.2.1", layout="wide")
...
# UI
# ══════════════════════════════════════════════════════════════════════════════
st.title("Portfolio Cockpit Alpha Pro v8.2.1")
...
with tabs[22]:  # Alerts
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v8.2.1: test alert.")
