...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v10.5.7", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v10.5.7")
...
with tabs[2]:  # Geographic Engine
    ...
    if rt is None or rt.empty:
        ...
        geo_pac = geographic_pac_priority(rt, pac_amount, regime_payload_geo, 0)
        if geo_pac.empty:
        ...
        eem_policy = eem_watchlist_policy(rt, 0)
        if eem_policy.empty:
...
with tabs[18]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v10.5.7: test alert.")
