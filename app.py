...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v10.5.1", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v10.5.1")
...
tabs=st.tabs(["Decision Center","🌍 Geographic Engine","Allocation","My Portfolio","Transactions","Scores","Decision Engine","Market","FRED","Relative Strength","Tactical Ranking","Satellite Auto","Backtest","Drift Monitor","Stress Test","Tax Engine","Data Quality","Scenario Simulator","Paper Trading","Alerts"])
...
with tabs[19]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v10.5.1: test alert.")
