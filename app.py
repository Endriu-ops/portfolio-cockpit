...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v10.6.0", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v10.6.0")
...
with tabs[2]:  # Geographic Engine
    ...
    if rt is None or rt.empty:
        ...
        st.info("Modulo Geographic PAC disattivato nella build stabile. Usa PAC Advisor operativo.")
        st.write("### EEM / nuovi ETF policy")
        st.info("Nuovi ETF bloccati di default; EEM solo watchlist manuale.")
        st.write("### Simulazione crescita VWCE")
        st.info("Simulazione VWCE disattivata nella build stabile.")
with tabs[3]:
...
with tabs[18]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v10.6.0: test alert.")
