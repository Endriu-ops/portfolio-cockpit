...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v10.5.8", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v10.5.8")
...
with tabs[2]:  # Geographic Engine
    ...
    if rt is None or rt.empty:
        ...
        geo_pac = geographic_pac_priority_safe(rt, pac_amount, regime_payload_geo)
        if geo_pac.empty:
...
with tabs[18]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v10.5.8: test alert.")
