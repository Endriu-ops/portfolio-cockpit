...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v8.3", layout="wide")
...
# UI
# ══════════════════════════════════════════════════════════════════════════════
st.title("Portfolio Cockpit Alpha Pro v8.3")
st.caption("v8.3 — Beta stress test · PAC intelligente · Ordini prioritizzati · LEI/PCE/P/C · Sanity check prezzi · UX semplificata")
...
with tabs[22]:  # Alerts
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v8.3: test alert.")
