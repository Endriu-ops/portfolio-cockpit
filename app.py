...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v6.5", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v6.5")
st.caption("Decision Engine v6.5: portfolio precompilato, persistence fix, BTC spot, MTHP fix.")
...
with tabs[18]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v6.5: test alert.")
