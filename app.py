...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v10.5", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v10.5")
...
with tabs[19]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v10.5: test alert.")
