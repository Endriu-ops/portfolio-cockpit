...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v8.3.1", layout="wide")
...
# UI
# ══════════════════════════════════════════════════════════════════════════════
st.title("Portfolio Cockpit Alpha Pro v8.3.1")
st.caption("v8.3.1 — Tax Optimizer Pro UI · Beta stress test · PAC intelligente · Ordini prioritizzati · Sanity check prezzi")
...
with tabs[17]:  # Tax Optimizer Pro
    st.subheader("🧾 Tax Optimizer Pro V8.3.1")
    ...
    if "real_table" not in st.session_state:
        ...
        st.info(
            "Gerarchia V8.3.1: 1) usa PAC/nuova liquidità; 2) compra sottopesi; "
            "3) vendi solo se entro budget fiscale; 4) differisci vendite con fiscal drag elevato."
        )


with tabs[18]:  # Tax Engine
...
with tabs[21]:  # Scenario Simulator
...
with tabs[23]:  # Alerts
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v8.3.1: test alert.")
