...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v6", layout="wide")
...
CORE = {
    ...
    "XZPRV": ("Small Cap Value / User ETF", 19.0, "Small Cap", "Equity"),
...
def stress_test_estimate(real_df, scenario):
    ...
    mapping = {
        ...
        "CMOD.MI":"Commodities","CBTC.MI":"Crypto","SXR8":"Equity","XZPRV":"Equity",
...
st.title("Portfolio Cockpit Alpha Pro v6")
st.caption("Decision Engine: regime, VIX protocol, drift monitor, stress test, explainability, tax-aware.")
...
tabs=st.tabs(["Decision Center","Allocation","My Portfolio","Transactions","Scores","Decision Engine","Market","FRED","Relative Strength","Tactical Ranking","Satellite Auto","Backtest","Drift Monitor","Stress Test","Tax Engine","Scenario Simulator","Paper Trading","Alerts"])
...
with tabs[17]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v6: test alert.")
