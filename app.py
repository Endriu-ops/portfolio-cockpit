# ═══════════════════════════════════════════════════════════════════════════════
# Portfolio Cockpit Alpha Pro — v8.1
...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v8.1", layout="wide")
...
def load_portfolio_primary(vix_override=None):
    """
    V8.1: carica prima portfolio_positions.csv.
...
# UI
# ══════════════════════════════════════════════════════════════════════════════
st.title("Portfolio Cockpit Alpha Pro v8.1")
st.caption("v8.1 — Beta stress test · PAC intelligente · Ordini prioritizzati · LEI/PCE/P/C · Sanity check prezzi · UX semplificata")
...
with tabs[22]:  # Alerts
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v8.1: test alert.")
