...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v5.2", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v5.2")
st.caption("Decision Center + inserimento manuale stabile + salvataggio CSV + storico transazioni.")
...
with tabs[14]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v5.2: test alert.")
