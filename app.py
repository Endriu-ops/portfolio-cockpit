...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v10.5.9", layout="wide")
...
st.title("Portfolio Cockpit Alpha Pro v10.5.9")
...
with tabs[2]:  # Geographic Engine
    ...
    if rt is None or rt.empty:
        ...
        st.info("Geographic PAC disattivato in Stable Build: usa PAC Advisor / Allocation per evitare blocchi runtime.")
        st.write("### EEM / nuovi ETF policy")
        eem_policy = eem_watchlist_policy_safe(rt)
        if eem_policy.empty:
...
with tabs[18]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v10.5.9: test alert.")
