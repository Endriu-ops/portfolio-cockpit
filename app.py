...
st.set_page_config(page_title="Portfolio Cockpit Alpha Pro v6.8", layout="wide")
...
PRELOADED_PORTFOLIO = [{'ticker': 'IBGS.MI', 'shares': 98.0, 'avg_price': 139.9, 'manual_price': 0, 'broker': '', 'note': ''}, {'ticker': 'MTHP.MI', 'shares': 193.0, 'avg_price': 73.1012, 'manual_price': 0, 'broker': '', 'note': ''}, {'ticker': 'SGLD.MI', 'shares': 70.974, 'avg_price': 208.48, 'manual_price': 0, 'broker': '', 'note': ''}, {'ticker': 'SXR8', 'shares': 10.419, 'avg_price': 588.85, 'manual_price': 0, 'broker': '', 'note': ''}, {'ticker': 'ZPRV', 'shares': 407.0, 'avg_price': 66.241, 'manual_price': 0, 'broker': '', 'note': ''}, {'ticker': 'BTC', 'shares': 0.126, 'avg_price': 70381.31, 'manual_price': 0, 'broker': '', 'note': 'BTC spot'}, {'ticker': 'CMOD.MI', 'shares': 460.0, 'avg_price': 27.195, 'manual_price': 0, 'broker': '', 'note': ''}, {'ticker': 'GDX.MI', 'shares': 110.0, 'avg_price': 85.01, 'manual_price': 0, 'broker': '', 'note': ''}, {'ticker': 'RBOT.MI', 'shares': 0.0, 'avg_price': 0.0, 'manual_price': 0, 'broker': '', 'note': 'AI'}, {'ticker': 'DFEN.MI', 'shares': 0.0, 'avg_price': 0.0, 'manual_price': 0, 'broker': '', 'note': 'Defense'}, {'ticker': 'SMH', 'shares': 46.0, 'avg_price': 101.18, 'manual_price': 0, 'broker': '', 'note': 'tattico 3%'}]
...
st.title("Portfolio Cockpit Alpha Pro v6.8")
st.caption("Decision Engine v6.8: safe EU ticker resolver for DFEN/SMH, tax monitor-only, persistence engine.")
...
with tabs[18]:
    msg=st.text_area("Messaggio","Portfolio Cockpit Alpha Pro v6.8: test alert.")
